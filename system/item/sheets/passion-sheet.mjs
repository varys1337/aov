...
export class AoVPassionSheet extends AoVItemSheet {
  ...
  async _prepareContext (options) {
    ...
    context.system.total = Number(context.system.base ?? 0) + Number(context.system.home ?? 0) + Number(context.system.history ?? 0) + Number(context.system.family ?? 0) + Number(context.system.xp ?? 0) + Number(context.system.effects ?? 0)
